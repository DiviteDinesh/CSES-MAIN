...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    static void solve() throws IOException{
        ...
        print((hs.size() - 1) + endl);
        for(int i = 0; i<hs.size()-1; i++){
            
            print(start + " " + hs.get(i)+endl);
        }
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static void main(String[] args) throws java.lang.Exception {
        if(!LOCALIO){
            ...
            // br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\Users\geeth\MAANG\DSA_JAVA\CP\CodeForces\input.txt")));
            // bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("C:\Users\geeth\MAANG\DSA_JAVA\CP\CodeForces\output.txt")));
        }
